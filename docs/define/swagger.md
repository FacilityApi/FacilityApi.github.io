...
| `definitions` | (see [Schema Object](#schema-object)) |
...
Defines one or more [methods](/define/fsd#methods).
...
Defines a [method](/define/fsd#methods).
...
Defines a request [field](/define/fsd#fields) and its type.
...
Defines response [fields](/define/fsd#fields) of a [method](/define/fsd#methods).
...
An items object, header object, or schema object. Defines a [DTO](/define/fsd#data-transfer-objects), a [field](/define/fsd#fields), or a field type.
