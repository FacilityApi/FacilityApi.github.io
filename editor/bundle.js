...
/***/ function(module, exports, __webpack_require__) {
	...
	if (window['monaco']) {
	    ...
	    window['onMonacoReady'] = index_1.default;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function default_1() {
	    ...
	    var baseUri = _.startsWith(window.location.href, 'http://local') ? 'http://localhost:45054/' : 'https://fsdgen.calexanderdev.com/';
	    var client = api.createHttpClient({ fetch: fetch, baseUri: baseUri });
	    ...
	    var generate = function () {
	        if (generating) {
	            ...
	            client
	                ...
	                var _a = result.value, output = _a.output, failure = _a.failure;
	                if (output && output.length) {
	                    ...
	                    output.forEach(function (file) {
	                        ...
	                        if (path.length) {
	                            ...
	                            if (!optgroup_1 || optgroup_1.label !== groupLabel) {
	                                optgroup_1 = document.createElement("optgroup");
	                                optgroup_1.label = groupLabel;
	                                fileList.appendChild(optgroup_1);
	                            }
	                        }
	                        var option = document.createElement("option");
	                        option.label = name;
	                        if (!selected_1 && lastFileName[generatorPicker.value] === name) {
	    ...
	    if (!leftMonaco.getModel().getValue()) {
	        leftMonaco.getModel().setValue(__webpack_require__(8));
	    }
	    leftMonaco.focus();
	    generate();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var facility_core_1 = __webpack_require__(7);
	/** Provides access to FacilityGeneratorApi over HTTP via fetch. */
	function createHttpClient(_a) {
	    var fetch = _a.fetch, baseUri = _a.baseUri;
	    return new FacilityGeneratorApiHttpClient(fetch, baseUri);
	}
	exports.createHttpClient = createHttpClient;
	var fetchResponse = facility_core_1.HttpClientUtility.fetchResponse, createResponseError = facility_core_1.HttpClientUtility.createResponseError;
	var FacilityGeneratorApiHttpClient = (function () {
	    function FacilityGeneratorApiHttpClient(fetch, baseUri) {
	    ...
	    FacilityGeneratorApiHttpClient.prototype.generate = function (request) {
	        var uri = 'generate';
	        var fetchRequest = {
	            method: 'POST',
	    ...
	    return FacilityGeneratorApiHttpClient;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	module.exports = __webpack_require__(10).polyfill();
